...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        水果管理
        <small>管理水果-基本信息</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> 主页</a></li>
        <li class="active">水果管理</li>
      </ol>
    </section>
      	...
      	<div class="col-xs-12">
        	<div class="box">
            	<div class="box-header">
                    <h3 class="box-title"><a href="/shuiguo?type=s"><span class="label label-primary">新增</span></a></h3>
                    <div class="box-tools">
    ...
    white-space: nowrap;
                	...
                	<table class="table table-hover table-bordered">
                    	<tbody>
                            ...
                            <c:forEach items="${shuiGuosList}" var="shuiguo">
                            <tr>
                            	<td>
                                	<input type="checkbox" name="shuiguo-${shuiguo.id}" />
                                </td>
                                <td>
                                	<a href="#">
                                ...
                                <td>${shuiguo.id}</td>
                                <td>${shuiguo.title}</td>
                                <td><a alt="url地址" href="${shuiguo.url}" target="_blank">查看</a></td>
                                <td><a alt="图片" href="/images/upload/${shuiguo.img}" target="_blank">查看</a></td>
                                <td><c:if test="${shuiguo.creatdId==1}">唐太明</c:if></td>
                                <td>${shuiguo.creatdDate}</td>
                            </tr>
                            </c:forEach>
                            <tr>
                            	<td></td>
                    ...
                    <div class="row">
                            ...
                            <div class="dataTables_length">
                                <label>
                                  ...
                                  <select class="form-control input-sm" name="size_length_safety" aria-controls="example1">
                                      <option value="/shuiguo?page=1&size=10" option-data="10" ${select_10}>10</option>
                                      <option value="/shuiguo?page=1&size=25" option-data="25" ${select_25}>25</option>
                                      <option value="/shuiguo?page=1&size=50" option-data="50" ${select_50}>50</option>
                                      <option value="/shuiguo?page=1&size=100" option-data="100" ${select_100}>100</option>
                                  </select>
                                  数量
                              </label>
                        ...
                        <div class="col-xs-6">
                        	<ul class="pagination pagination-sm no-margin pull-right">
                              ...
                              <li>
                                  <a href="/shuiguo?page=${page.pageNumber-1}&size=${page.pageSize}">«</a>
                              </li>
                              </c:if>
                              ...
                              <c:forEach items="${showPage}" var="sp">
                           	  <c:choose>
                           	  	...
                           	  	<c:otherwise>
                           	  	  ...
                           	  	  <c:set var="href" value="href='/shuiguo?page=${sp}&size=${page.pageSize}'" scope="request" />
                           	  	</c:otherwise>
                           	  </c:choose>
