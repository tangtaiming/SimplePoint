	  ...
	  <div class="box box-info">
        <form class="form-horizontal" action="/store/${store.id}" method="post">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="status">兼职状态:</label>
                    <div class="col-sm-5">
                    	<select name="recruitment" class="form-control">
                    		<c:forEach items="${recruitmentSelect}" var="recruitment">
                    			<option value="${recruitment.key}" ${recruitment.value[0]}>${recruitment.value[1]}</option>
                    		</c:forEach>
                        </select>
                    </div>
                    <div class="col-sm-5">
            ...
            <div class="box-footer">
            	<div class="col-sm-offset-1 col-sm-11">
					...
					<input type="hidden" name="webType" value="editRecruitment" />
