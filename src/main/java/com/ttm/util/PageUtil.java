...
public class PageUtil {
	 ...
	 * @return
	 */
	public Page createPage(int pageNumber, int pageSize, int totalNumber, int pageRange) {
		pageNumber = getPageNumber(pageNumber);
		pageSize = getPageSize(pageSize);
		int totalPage = getTotalPage(totalNumber, pageSize);

		Map<String, Integer> rangeData = fetchRange(pageNumber, totalPage, pageRange);
		...
		Page page = new Page(pageNumber, pageSize, pageRange, totalPage, totalNumber, rangeStart, rangeEnd, previous,
				next);
		return page;
	}
	 ...
	 * @return
	 */
	private Map<String, Integer> fetchRange(int currentPage, int totalPage, int pageRange) {
