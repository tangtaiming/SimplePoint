...
public class Md5 {
	...
	public static String GetMD5Code(String strObj, int type) {
	...
	public static String getEncode(String text, int type) {
		return GetMD5Code(text, type);
	}
	
	public static String getEncode(String text) {
		return GetMD5Code(text, 2);
	}
